        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You were successfully logged in');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              location.reload(); //showAlert('success', 'You were successfully logged out');
            }
...
var displayMap = function displayMap(locations) {
  try {
    var mapSetup = function mapSetup() {
      mapboxgl.accessToken = 'pk.eyJ1IjoiaHVnb3BjdmVsb3NvIiwiYSI6ImNrbDB1ZGpmMTV6cmUydnF0eTgxcHdrOG0ifQ.pua0YPFGxJuj_gwVRj44KA';
      ...
      locations.forEach(function (location) {
        ...
        new mapboxgl.Popup({
          offset: 40
        }).setLngLat(location.coordinates).setHTML("<p> <strong>Day ".concat(location.day, "</strong> : ").concat(location.description, "</p>")).addTo(map); // Extend map bounds to include current location
      ...
      map.on('load', function () {
        map.addSource('route', {
          ...
          data: {
            ...
            geometry: {
              type: 'LineString',
              coordinates: locations.map(function (el) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe'; //console.log(url);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51INej4LCKkBhLn06de52vz3KRfJeeNhjf3EHAfzJCm0KwOZk3hZ4ANyTf60k6S7VQxUzOLIzy2HNNDqkMEUyO1Yc00KABduvup'); //1) get checkout session from API endpoint
          ...
          case 7:
            (0, _alerts.showAlert)('success', 'payment successfull');
            _context.next = 14;
            break;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; //datasets convert dash into camelCase
